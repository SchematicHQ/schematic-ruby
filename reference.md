...
<details><summary><code>client.credits.<a href="/lib/schematic/credits/client.rb">release_credit_lease</a>(lease_id:) -> Schematic::Credits::Types::ReleaseCreditLeaseResponse</code></summary>
<dl>
<dd>
...
```ruby
client.credits.release_credit_lease(lease_id: "lease_id")
```
</dd>
</dl>
</dd>
...
<details><summary><code>client.credits.<a href="/lib/schematic/credits/client.rb">release_credit_reservation</a>(reservation_id:) -> Schematic::Credits::Types::ReleaseCreditReservationResponse</code></summary>
<dl>
<dd>
...
```ruby
client.credits.release_credit_reservation(reservation_id: "reservation_id")
```
</dd>
</dl>
</dd>
