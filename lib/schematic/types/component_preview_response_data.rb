...
module Schematic
  module Types
    class ComponentPreviewResponseData < Internal::Types::Model
      ...
      field :invoices, -> { Internal::Types::Array[Schematic::Types::InvoiceResponseData] }, optional: false, nullable: false
      ...
      field :upcoming_invoice, -> { Schematic::Types::UpcomingInvoiceResponseData }, optional: true, nullable: false
    end
  end
end
