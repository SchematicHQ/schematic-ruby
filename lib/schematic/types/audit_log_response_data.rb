...
module Schematic
  module Types
    class AuditLogResponseData < Internal::Types::Model
      field :account_member_id, -> { String }, optional: true, nullable: false
      ...
      field :req_body, -> { String }, optional: true, nullable: false
      ...
      field :resp_body, -> { String }, optional: true, nullable: false
