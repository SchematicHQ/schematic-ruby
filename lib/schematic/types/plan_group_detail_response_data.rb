...
module Schematic
  module Types
    class PlanGroupDetailResponseData < Internal::Types::Model
      ...
      field :fallback_plan, -> { Schematic::Types::PlanGroupPlanDetailResponseData }, optional: true, nullable: false

      field :fallback_plan_id, -> { String }, optional: true, nullable: false

      field :id, -> { String }, optional: false, nullable: false

      field :initial_plan, -> { Schematic::Types::PlanGroupPlanDetailResponseData }, optional: true, nullable: false

      field :initial_plan_id, -> { String }, optional: true, nullable: false

      field :initial_plan_price, -> { Schematic::Types::BillingPriceView }, optional: true, nullable: false

      field :initial_plan_price_id, -> { String }, optional: true, nullable: false

      field :ordered_add_on_list, -> { Internal::Types::Array[Schematic::Types::PlanGroupPlanEntitlementsOrder] }, optional: false, nullable: false

      field :ordered_bundle_list, -> { Internal::Types::Array[Schematic::Types::PlanGroupBundleOrder] }, optional: false, nullable: false

      field :ordered_plan_list, -> { Internal::Types::Array[Schematic::Types::PlanGroupPlanEntitlementsOrder] }, optional: false, nullable: false
      ...
      field :trial_eligibility_per_plan, -> { Internal::Types::Boolean }, optional: false, nullable: false

      field :trial_expiry_plan, -> { Schematic::Types::PlanGroupPlanDetailResponseData }, optional: true, nullable: false

      field :trial_expiry_plan_id, -> { String }, optional: true, nullable: false

      field :trial_expiry_plan_price, -> { Schematic::Types::BillingPriceView }, optional: true, nullable: false
