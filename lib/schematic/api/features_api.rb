...
module Schematic
  class FeaturesApi
    ...
    # @param audience_request_body [AudienceRequestBody] 
    # @param [Hash] opts the optional parameters
    # @option opts [String] :x_schematic_environment_id If the request is made using an API key that is not environment-scoped, specify the environment using this header
    # @return [CountCompaniesAudienceResponse]
    def count_companies_audience(audience_request_body, opts = {})
      data, _status_code, _headers = count_companies_audience_with_http_info(audience_request_body, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [String] :x_schematic_environment_id If the request is made using an API key that is not environment-scoped, specify the environment using this header
    # @return [Array<(CountCompaniesAudienceResponse, Integer, Hash)>] CountCompaniesAudienceResponse data, response status code and response headers
    def count_companies_audience_with_http_info(audience_request_body, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: FeaturesApi.count_companies_audience ...'
      end
      # verify the required parameter 'audience_request_body' is set
      if @api_client.config.client_side_validation && audience_request_body.nil?
        fail ArgumentError, "Missing the required parameter 'audience_request_body' when calling FeaturesApi.count_companies_audience"
      end
      # resource path
      local_var_path = '/audience/count-companies'
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(audience_request_body)

      # return_type
      return_type = opts[:debug_return_type] || 'CountCompaniesAudienceResponse'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['ApiKeyAuth']

      new_options = opts.merge(
        :operation => :"FeaturesApi.count_companies_audience",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: FeaturesApi#count_companies_audience\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def count_users_audience(audience_request_body, opts = {})
      data, _status_code, _headers = count_users_audience_with_http_info(audience_request_body, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [String] :x_schematic_environment_id If the request is made using an API key that is not environment-scoped, specify the environment using this header
    # @return [Array<(CountUsersAudienceResponse, Integer, Hash)>] CountUsersAudienceResponse data, response status code and response headers
    def count_users_audience_with_http_info(audience_request_body, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: FeaturesApi.count_users_audience ...'
      end
      # verify the required parameter 'audience_request_body' is set
      if @api_client.config.client_side_validation && audience_request_body.nil?
        fail ArgumentError, "Missing the required parameter 'audience_request_body' when calling FeaturesApi.count_users_audience"
      end
      # resource path
      local_var_path = '/audience/count-users'
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'CountUsersAudienceResponse'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['ApiKeyAuth']

      new_options = opts.merge(
        :operation => :"FeaturesApi.count_users_audience",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: FeaturesApi#count_users_audience\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_companies_audience(audience_request_body, opts = {})
      data, _status_code, _headers = get_companies_audience_with_http_info(audience_request_body, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [String] :x_schematic_environment_id If the request is made using an API key that is not environment-scoped, specify the environment using this header
    # @return [Array<(GetCompaniesAudienceResponse, Integer, Hash)>] GetCompaniesAudienceResponse data, response status code and response headers
    def get_companies_audience_with_http_info(audience_request_body, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: FeaturesApi.get_companies_audience ...'
      end
      # verify the required parameter 'audience_request_body' is set
      if @api_client.config.client_side_validation && audience_request_body.nil?
        fail ArgumentError, "Missing the required parameter 'audience_request_body' when calling FeaturesApi.get_companies_audience"
      end
      # resource path
      local_var_path = '/audience/get-companies'
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'GetCompaniesAudienceResponse'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['ApiKeyAuth']

      new_options = opts.merge(
        :operation => :"FeaturesApi.get_companies_audience",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: FeaturesApi#get_companies_audience\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_users_audience(audience_request_body, opts = {})
      data, _status_code, _headers = get_users_audience_with_http_info(audience_request_body, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [String] :x_schematic_environment_id If the request is made using an API key that is not environment-scoped, specify the environment using this header
    # @return [Array<(GetUsersAudienceResponse, Integer, Hash)>] GetUsersAudienceResponse data, response status code and response headers
    def get_users_audience_with_http_info(audience_request_body, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: FeaturesApi.get_users_audience ...'
      end
      # verify the required parameter 'audience_request_body' is set
      if @api_client.config.client_side_validation && audience_request_body.nil?
        fail ArgumentError, "Missing the required parameter 'audience_request_body' when calling FeaturesApi.get_users_audience"
      end
      # resource path
      local_var_path = '/audience/get-users'
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'GetUsersAudienceResponse'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['ApiKeyAuth']

      new_options = opts.merge(
        :operation => :"FeaturesApi.get_users_audience",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: FeaturesApi#get_users_audience\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
