...
module Schematic
  module Credits
    module Types
      class CreateBillingCreditRequestBody < Internal::Types::Model
        field :burn_strategy, -> { Schematic::Types::BillingCreditBurnStrategy }, optional: true, nullable: false
        field :currency, -> { String }, optional: false, nullable: false
        field :currency_prices, -> { Internal::Types::Array[Schematic::Types::CreditCurrencyPriceRequestBody] }, optional: true, nullable: false
