...
describe Schematic::Internal::Types::Utils do
  Utils = Schematic::Internal::Types::Utils

  module TestUtils
    class M < Schematic::Internal::Types::Model
      field :value, String
    end

    class UnionMemberA < Schematic::Internal::Types::Model
      literal :type, "A"
      field :only_on_a, String
    end

    class UnionMemberB < Schematic::Internal::Types::Model
      literal :type, "B"
    ...
    SymbolStringHash = Schematic::Internal::Types::Hash[Symbol, String]
    SymbolModelHash = -> { Schematic::Internal::Types::Hash[Symbol, TestUtils::M] }
  end
  ...
  describe ".coerce" do
    ...
    describe "String" do
      ...
      it "raises an error if value cannot be coerced and strict" do
        assert_raises Schematic::Internal::Errors::TypeError do
    ...
    describe "Array" do
      StringArray = Schematic::Internal::Types::Array[String]
      ModelArray = -> { Schematic::Internal::Types::Array[TestUtils::M] }
      UnionArray = -> { Schematic::Internal::Types::Array[TestUtils::U] }
