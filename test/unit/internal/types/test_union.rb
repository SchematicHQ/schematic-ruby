...
describe Schematic::Internal::Types::Union do
  class Rectangle < Schematic::Internal::Types::Model
    literal :type, "square"

    field :area, Float
  end

  class Circle < Schematic::Internal::Types::Model
    literal :type, "circle"

    field :area, Float
  end

  class Pineapple < Schematic::Internal::Types::Model
