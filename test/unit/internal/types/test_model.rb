...
describe Schematic::Internal::Types::Model do
  ...
  class ExampleModel < Schematic::Internal::Types::Model
    field :name, String
  ...
  class ExampleWithBooleans < Schematic::Internal::Types::Model
    field :enabled, Schematic::Internal::Types::Boolean
    field :archived, Schematic::Internal::Types::Boolean, default: true
  end

  class ExampleWithFalseDefault < Schematic::Internal::Types::Model
    field :archived, Schematic::Internal::Types::Boolean, default: false
  end

  class ExampleChild < Schematic::Internal::Types::Model
    field :value, String
  end

  class ExampleParent < Schematic::Internal::Types::Model
  ...
  describe "#inspect" do
    class SensitiveModel < Schematic::Internal::Types::Model
