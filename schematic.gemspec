...
require_relative "lib/schematic/version"
...
Gem::Specification.new do |spec|
  spec.name = "schematichq"
  spec.authors = ["Schematic"]
  spec.version = Schematic::VERSION
  spec.summary = "Ruby client library for the Schematic API"
  spec.description = "The Schematic Ruby library provides convenient access to the Schematic API from Ruby."
  ...
  spec.add_dependency "wasmtime", ">= 19.0"
